    ...
    <nav className="w-full flex justify-center items-center py-[21px] relative z-50"> 
      ...
      >
        <div className="flex flex-col items-center gap-8 w-full">
          <Link onClick={() => setIsOpen(false)} href="/jobs" className="text-[#515B6F] text-[16px] font-medium font-Epilogue hover:text-[#4640DE] transition-colors leading-[160%]">
            Find Jobs
          </Link>
          <Link onClick={() => setIsOpen(false)} href="/admin" className="text-[#515B6F] text-[16px] font-medium font-Epilogue hover:text-[#4640DE] transition-colors leading-[160%]">
            Admin
          </Link>
          
          <div className="w-full h-px bg-[#D6DDEB] my-2"></div>
          
          <Link onClick={() => setIsOpen(false)} href="#" className="cursor-pointer text-[#4640DE] text-[16px] font-Epilogue font-bold hover:text-[#3b36be] transition-colors">
            Login
          </Link>
